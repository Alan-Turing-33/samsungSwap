...
def map_cBand (market_id) :
   ...
   market_locations =   all_eNB_location.loc [all_eNB_location['marketId'] == market_id, ['Global eNodeB ID','BBU Latitude Coordinates', 'BBU Longitude Coordinates']]
   ...
   try :
     m = folium.Map(location= [ avg_long, avg_lat])
   except :
       print ('cant create map at ', [ avg_long, avg_lat])
       return 
   marker_added = 0 
   marker_failed = 0  
   ...
   m.save ('C:/Users/fn101139/Documents/SamsungSwap/12-05-2022/maps/cBand_map_' + str (market_id) + '.html')


for market in [ 86, 79, 80, 81, 82, 84, 85, 86, 87, 88, 89, 90, 91, 96, 97, 98, 99,
