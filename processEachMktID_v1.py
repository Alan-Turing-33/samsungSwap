...
#        
    ...
    NumSectors = MktData['uniqueSector'].nunique()
    
    NumSectorsSamsung = MktData.loc [MktData ['vendor'] == 'Samsung', 'uniqueSector' ].nunique()
    NumSectorsNokia = MktData.loc [(MktData ['vendor'] == 'mmNokia') | (MktData.vendor == 'cmNokia') , 'uniqueSector'].nunique()
    allcmWave = MktData.loc [(MktData ['freqType'] == 'cmW') , 'uniqueSector'].nunique() 
    allmmWave = MktData.loc [(MktData ['freqType'] == 'mmW') , 'uniqueSector'].nunique() 
    allcBand = MktData.loc [(MktData ['freqType'] == 'cBand') , 'uniqueSector'].nunique() 
    allNokiacm = MktData.loc [(MktData ['freqType'] == 'cmW') & (MktData.vendor == 'cmNokia')  , 'uniqueSector'].nunique()  
    allNokiamm = MktData.loc [(MktData ['freqType'] == 'mmW') & (MktData.vendor == 'mmNokia')  , 'uniqueSector'].nunique()  

    NumNeighbourgNB = MktData['nbrGnbId'].nunique()
    NUmNeighbourCEllId = MktData['Value'].nunique()
    
    
    
##    for sector in pd.unique (MktData['uniqueSector']):
##         sectorData = MktData [MktData ['uniqueSector'] == sector]
